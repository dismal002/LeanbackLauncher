...
import com.marshmallow.launcher.DropTarget.DragObject;
import com.marshmallow.launcher.PagedView.PageSwitchListener;
import com.marshmallow.launcher.allapps.AllAppsContainerView;
import com.marshmallow.launcher.allapps.DefaultAppSearchController;
import com.marshmallow.launcher.compat.AppWidgetManagerCompat;
import com.marshmallow.launcher.compat.LauncherActivityInfoCompat;
import com.marshmallow.launcher.compat.LauncherAppsCompat;
import com.marshmallow.launcher.compat.UserHandleCompat;
import com.marshmallow.launcher.compat.UserManagerCompat;
import com.marshmallow.launcher.model.WidgetsModel;
import com.marshmallow.launcher.util.ComponentKey;
import com.marshmallow.launcher.util.LongArrayMap;
import com.marshmallow.launcher.util.PackageManagerHelper;
import com.marshmallow.launcher.util.TestingUtils;
import com.marshmallow.launcher.util.Thunk;
import com.marshmallow.launcher.widget.PendingAddWidgetInfo;
import com.marshmallow.launcher.widget.WidgetHostViewLoader;
import com.marshmallow.launcher.widget.WidgetsContainerView;
...
public class Launcher extends Activity
    ...
    public static final String ACTION_APPWIDGET_HOST_RESET =
            "com.marshmallow.launcher.intent.ACTION_APPWIDGET_HOST_RESET";
    private static final String EXTRA_WALLPAPER_OFFSET =
            "com.marshmallow.launcher.WALLPAPER_OFFSET";
    ...
    static final String INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION =
            "com.marshmallow.launcher.intent.extra.shortcut.INGORE_LAUNCH_ANIMATION";
    ...
    static final String ACTION_FIRST_LOAD_COMPLETE =
            "com.marshmallow.launcher.action.FIRST_LOAD_COMPLETE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ReceiverCompat.registerNotExported(this, mCloseSystemDialogsReceiver, filter);
        ...
        boolean isAllApps = getIntent() != null && getIntent().getBooleanExtra("SHOW_ALL_APPS", false);
        if (isAllApps) {
    ...
    protected void onResume() {
        ...
        if (getIntent() != null && getIntent().getBooleanExtra("SHOW_ALL_APPS", false)) {
            mOnResumeState = State.APPS;
        }
    ...
    protected boolean hasSettings() {
        return true; // Always show settings — includes theme switcher
    }
    ...
    public void onAttachedToWindow() {
        ...
        ReceiverCompat.registerNotExported(this, mReceiver, filter);
    ...
    public void setQsbBar(View qsb) {
        mQsb = qsb;
    }
    ...
    protected void onClickWallpaperPicker(View v) {
        ...
        Intent wallpaperIntent = new Intent(Intent.ACTION_SET_WALLPAPER)
                .putExtra(EXTRA_WALLPAPER_OFFSET, offset);
        Intent chooser = Intent.createChooser(wallpaperIntent, getText(R.string.wallpaper_button_text));
        try {
            startActivityForResult(chooser, REQUEST_PICK_WALLPAPER);
        } catch (ActivityNotFoundException e) {
            Toast.makeText(this, R.string.wallpaper_picker_not_found, Toast.LENGTH_SHORT).show();
            Log.e(TAG, "Unable to open wallpaper picker", e);
            return;
        }
    ...
    protected void onClickSettingsButton(View v) {
        ...
        final String current = getSharedPreferences(PREFS, MODE_PRIVATE)
                .getString(KEY, "launcher3-m");
        int currentIndex = 0;
        for (int i = 0; i < themes.length; i++) {
            if (themes[i].equals(current)) { currentIndex = i; break; }
        }
        new AlertDialog.Builder(this, android.R.style.Theme_Material_Light_Dialog_Alert)
            ...
            .setSingleChoiceItems(displayNames, currentIndex, (dialog, which) -> {
                ...
                getSharedPreferences(PREFS, MODE_PRIVATE).edit().putString(KEY, selected).commit();
                applyThemeAlias(selected);
                dialog.dismiss();
                startActivity(buildThemeLaunchIntent(selected));
            })
            .setNegativeButton(android.R.string.cancel, null)
            .show();
    }

    private void applyThemeAlias(String theme) {
        ...
        boolean[] enabled = {
            theme.equals("launcher1-d"), theme.equals("launcher2-g"), theme.equals("launcher2-j"),
            theme.equals("launcher3-m"), theme.equals("launcher3-o"), theme.equals("launcher3-h")
        };
        for (int i = 0; i < aliases.length; i++) {
            int desired = enabled[i]
                ? PackageManager.COMPONENT_ENABLED_STATE_ENABLED
                : PackageManager.COMPONENT_ENABLED_STATE_DISABLED;
            ComponentName cn = new ComponentName(pkg, aliases[i]);
    ...
    private Intent buildThemeLaunchIntent(String theme) {
        String pkg = getPackageName();
        String cls;
        switch (theme) {
            ...
            default:            cls = "com.marshmallow.launcher.Launcher"; break;
        }
    ...
    public @Thunk void bindScreens(ArrayList<Long> orderedScreenIds) {
...
interface DebugIntents {
    static final String DELETE_DATABASE = "com.marshmallow.launcher.action.DELETE_DATABASE";
    static final String MIGRATE_DATABASE = "com.marshmallow.launcher.action.MIGRATE_DATABASE";
}
